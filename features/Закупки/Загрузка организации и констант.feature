...
@ТипШага: Загрузка данных (тесты)
@Описание: Загрузка констант и организаций
@ПримерИспользования: И загружаю тестовые данные
Сценарий: Заполнение констант и организаций
